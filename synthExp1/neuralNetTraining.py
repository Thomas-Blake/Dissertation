...
if __name__ == "__main__":
    ...
    ax2.plot(balanced_performance,color='black')
    ax2.plot(uniform_performance,color='grey')
    ax2.set_xlabel("Epoch")
    ax2.set_ylabel("Accuracy on tail classes")
    ax2.set_xscale("log")
    ax2.legend(["Neural Net Balanced loss","Neural Net cross-entropy loss"])
    plt.savefig('synthExp1/images/neuralNetPerformance',dpi=300)
