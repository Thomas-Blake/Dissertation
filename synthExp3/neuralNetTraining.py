...
def printDecBoundary(ax,model,detail=1000,color='black',modeltype="torch",distCount=11,a=-10,b=10):
    x1=np.linspace(a,b,detail+1)
    x2=np.linspace(a,b,detail+1)
...
if __name__ == "__main__":
    ...
    if True:
        if balancedLoss:
            ...
            with open('./synthExp2/normalNeuralNetBoundary.pkl', 'wb') as f:
                pickle.dump(boundary, f)
